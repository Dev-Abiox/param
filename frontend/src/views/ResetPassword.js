    ...
    return (
      <div className="min-h-screen bg-slate-100 dark:bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
          ...
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">This link is missing a reset token. Please request a new password reset.</p>
          <button
            onClick={() => navigate("/login")}
            className="mt-6 px-4 py-2 bg-teal-700 text-white rounded-md text-sm font-medium hover:bg-teal-800"
          >
            Back to Login
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-slate-900 dark:text-slate-100 tracking-tight">Reset Password</h2>
        <p className="mt-2 text-center text-sm text-slate-600 dark:text-slate-300">Enter your new password below</p>
      </div>
        ...
        <div className="bg-white dark:bg-slate-900 py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-slate-200 dark:border-slate-700">
          {success ? (
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Password Reset Successfully</h3>
